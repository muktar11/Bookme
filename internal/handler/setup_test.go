...
//location for create templatetestCahe for outside template folder
...
func CreateTestTemplateCache() (map[string]*template.Template, error) {
	...
	//change the address of the html template folder vecasue we run
	//the test from handlers folder not from the main package
