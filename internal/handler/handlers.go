...
func (m *Repository) PostReservation(w http.ResponseWriter, r *http.Request) {
	...
	//we has to modify the data cause we use.time.Now() in query
	...
	layout := "2006-01-02"
	//change the picked time to time.TIme()
	...
	//conver the string to int of roomid
	...
	//createing toom restriction along the room resrevation
...
func (m *Repository) AdminReservationsCalendar(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		fmt.Println("failed before rooms")
		helpers.ServerError(w, err)
		return
	}
	...
	for _, x := range rooms {
		...
		if err != nil {
			fmt.Println("failed before roomdate")
			helpers.ServerError(w, err)
			return
		}
